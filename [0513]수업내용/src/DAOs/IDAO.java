...
public interface IDAO {
	...
	public void createTable() throws SQLException;//create Account는 Directory를 만들어서 안에 여러 파일이 들어가도록 설계
	public void insertData() throws SQLException;//SQLException  을 그냥  Exception으로 빼고,
	public void updataData() throws SQLException;//인터페이스는 똑같이해서 File을 구현해 와라.
